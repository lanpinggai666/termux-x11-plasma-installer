...
else aria2c -x 16 -s 16 https://github-proxy.kongkuang.icu/github.com/kde-yyds/termux-x11-plasma-image/releases/download/v1.0/termux.tar.xz >log.txt
fi
...
else aria2c -x 16 -s 16 https://github-proxy.kongkuang.icu/https://github.com/kde-yyds/termux-x11-plasma-image/releases/download/v1.0/plasma.tar.xz.7z.001 >log.txt
fi
...
else aria2c -x 16 -s 16 https://github-proxy.kongkuang.icu/github.com/kde-yyds/termux-x11-plasma-image/releases/download/v1.0/plasma.tar.xz.7z.002 >log.txt
fi
...
else aria2c -x 16 -s 16 https://github-proxy.kongkuang.icu/github.com/kde-yyds/termux-x11-plasma-image/releases/download/v1.0/plasma.tar.xz.7z.003 >log.txt
fi
...
else aria2c -x 16 -s 16 https://github-proxy.kongkuang.icu/github.com/kde-yyds/termux-x11-plasma-image/releases/download/v1.0/plasma.tar.xz.7z.004 >log.txt
fi
...
else aria2c -x 16 -s 16 https://github-proxy.kongkuang.icu/github.com/kde-yyds/termux-x11-plasma-image/releases/download/v1.0/plasma.tar.xz.7z.005 >log.txt
fi
